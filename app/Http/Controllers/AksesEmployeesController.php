...
class AksesEmployeesController extends Controller
{
    ...
    public function memanggilApiInsert(Request $request)
    {
        ...
        ])->post('http://localhost/1201220037/public/api/employees', $data);
    ...
    public function memanggilApiUpdate(Request $request, $id)
    {
        ...
        $response = Http::withHeaders([
            'Accept' => 'application/json',
            'Authorization' => 'Bearer ' . $token,
        ])->put('http://localhost/1201220037/public/api/employees/' . $id, $data);
    ...
    public function memanggilApiDelete($id)
    {
        ...
        $response = Http::withHeaders([
            'Accept' => 'application/json',
            'Authorization' => 'Bearer ' . $token,
        ])->delete('http://localhost/1201220037/public/api/employees/' . $id);
